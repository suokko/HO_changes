// %1117899257062:hoplugins.seriesstats.ui%
/*
...
public class RatingPanelTab extends JPanel implements ActionListener {
    ...
    public RatingPanelTab() {
        ...
        jPanel1.add(this.JCBTeam1,
                    new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0, GridBagConstraints.SOUTH,
        ...
        jPanel1.add(this.JCBTeam2,
                    new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0, GridBagConstraints.SOUTH,
                                           GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0),
                                           0, 0));
        ...
        jPanel1.add(this.JCBDate1,
                    new GridBagConstraints(2, 2, 1, 1, 0.0, 0.0, GridBagConstraints.NORTH,
                                           GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0),
                                           0, 0));
        ...
        jPanel1.add(this.JCBDate2,
                    new GridBagConstraints(3, 2, 1, 1, 0.0, 0.0, GridBagConstraints.NORTH,
                                           GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0),
                                           0, 0));

        this.RatingRatings = new RatingsPanel(Commons.getModel());
        jPanel1.add(this.RatingRatings.getPanel(),
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if ((event.getSource().equals(JCBDate1) || event.getSource().equals(JCBDate2))
            && (JCBDate1.getItemCount() > 1)
            && (JCBDate2.getItemCount() > 1)) {
            refreshPanelBewertung();
        }
    }
    ...
    private void RefreshTeamBox() {
        try {
            ...
            ITabellenVerlaufEintrag[] dummy = Commons.getModel().getSpielplan(ligaId, season)
