...
public class Curve {
  ...
  public Date getDate()                    { return m_currentPoint.m_dDate; }
  public double getSpirit()                { return m_currentPoint.m_dSpirit; }
  public int getAttitude()                 { return m_currentPoint.m_iAttitude; }
  public int getMatchType()                { return m_currentPoint.m_iMatchType; }
  public int getMatchDay()                 { return m_currentPoint.m_iMatchDay; }
  public String getTooltip()			 { return m_currentPoint.m_strTooltip; }
  public Color getColor()                  { return m_Color; }
  public int getPointType()                { return m_currentPoint.m_iPointType; }
  public void setColor(Color color)        { m_Color = color; }
  public Point getFirstPoint()             { return m_clPoints.get(0); }
  public Point getLastPoint()              { return m_clPoints.get(m_clPoints.size() - 1); }
  public void addPoint(int i, Point point) { m_clPoints.add(i, new Point(point)); }
