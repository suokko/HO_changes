...
public interface IFinanzen {
     ...
     */
    public void setEinnahmenGesamt(int m_iEinnahmenGesamt);
     ...
     */
    public void setEinnahmenSonstige(int m_iEinnahmenSonstige);
     ...
     */
    public int getEinnahmenSonstige();
     ...
     */
    public void setEinnahmenSponsoren(int m_iEinnahmenSponsoren);
     ...
     */
    public int getEinnahmenSponsoren();
     ...
     */
    public void setEinnahmenZinsen(int m_iEinnahmenZinsen);
     ...
     */
    public void setEinnahmenZuschauer(int m_iEinnahmenZuschauer);
     ...
     */
    public int getEinnahmenZuschauer();
     ...
     */
    public void setFinanzen(int m_iFinanzen);
     ...
     */
    public void setGewinnVerlust(int m_iGewinnVerlust);
     ...
     */
    public void setKostenGesamt(int m_iKostenGesamt);
     ...
     */
    public void setKostenJugend(int m_iKostenJugend);
     ...
     */
    public void setKostenSonstige(int m_iKostenSonstige);
     ...
     */
    public void setKostenSpieler(int m_iKostenSpieler);
     ...
     */
    public void setKostenStadion(int m_iKostenStadion);
     ...
     */
    public void setKostenTrainerstab(int m_iKostenTrainerstab);
     ...
     */
    public int getKostenTrainerstab();
     ...
     */
    public void setKostenZinsen(int m_iKostenZinsen);
     ...
     */
    public void setLetzteEinnahmenGesamt(int m_iLetzteEinnahmenGesamt);
     ...
     */
    public int getLetzteEinnahmenGesamt();
     ...
     */
    public void setLetzteEinnahmenSonstige(int m_iLetzteEinnahmenSonstige);
     ...
     */
    public int getLetzteEinnahmenSonstige();
     ...
     */
    public void setLetzteEinnahmenSponsoren(int m_iLetzteEinnahmenSponsoren);
     ...
     */
    public int getLetzteEinnahmenSponsoren();
     ...
     */
    public void setLetzteEinnahmenZinsen(int m_iLetzteEinnahmenZinsen);
     ...
     */
    public int getLetzteEinnahmenZinsen();
     ...
     */
    public void setLetzteEinnahmenZuschauer(int m_iLetzteEinnahmenZuschauer);
     ...
     */
    public int getLetzteEinnahmenZuschauer();
     ...
     */
    public void setLetzteGewinnVerlust(int m_iLetzteGewinnVerlust);
     ...
     */
    public int getLetzteGewinnVerlust();
     ...
     */
    public void setLetzteKostenGesamt(int m_iLetzteKostenGesamt);
     ...
     */
    public int getLetzteKostenGesamt();
     ...
     */
    public void setLetzteKostenJugend(int m_iLetzteKostenJugend);
     ...
     */
    public int getLetzteKostenJugend();
     ...
     */
    public void setLetzteKostenSonstige(int m_iLetzteKostenSonstige);
     ...
     */
    public int getLetzteKostenSonstige();
     ...
     */
    public void setLetzteKostenSpieler(int m_iLetzteKostenSpieler);
     ...
     */
    public int getLetzteKostenSpieler();
     ...
     */
    public void setLetzteKostenStadion(int m_iLetzteKostenStadion);
     ...
     */
    public int getLetzteKostenStadion();
     ...
     */
    public void setLetzteKostenTrainerstab(int m_iLetzteKostenTrainerstab);
     ...
     */
    public int getLetzteKostenTrainerstab();
     ...
     */
    public void setLetzteKostenZinsen(int m_iLetzteKostenZinsen);
     ...
     */
    public int getLetzteKostenZinsen();
     ...
     */
    public void setSponsoren(int m_iSponsoren);
     ...
     */
    public void setSupporter(int m_iSupporter);
