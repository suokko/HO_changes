                                                     ...
                                                     de.hattrickorganizer.gui.Refreshable
{
    ...
    private void initComponents() {
        ...
        if (m_clTyp == TESTARENA) {
            ...
            label = new JLabel(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Gesamtgroesse"));
            ...
            label = new JLabel(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Stehplaetze"));
            constraints2.gridx = 0;
            ...
            label = new JLabel(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Sitzplaetze"));
            constraints2.gridx = 0;
            ...
            label = new JLabel(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Ueberdachteplaetze"));
            constraints2.gridx = 0;
            ...
            label = new JLabel(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Logen"));
            constraints2.gridx = 0;
            ...
            label = new JLabel(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Fans"));
            constraints2.gridx = 0;
        ...
        m_jtArena.setDefaultRenderer(java.lang.Object.class,
    ...
    private void initTabelle() {
        ...
        tabellenwerte[0][1] = new ColorLabelEntry(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Aktuell"),
                                                  ColorLabelEntry.FG_STANDARD,
                                                  ColorLabelEntry.BG_SPIELERPOSITONSWERTE,
                                                  SwingConstants.CENTER);
        tabellenwerte[0][2] = new ColorLabelEntry(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Maximal"),
                                                  ColorLabelEntry.FG_STANDARD,
                                                  ColorLabelEntry.BG_SPIELERPOSITONSWERTE,
                                                  SwingConstants.CENTER);
        tabellenwerte[0][3] = new ColorLabelEntry(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Durchschnitt"),
                                                  ColorLabelEntry.FG_STANDARD,
                                                  ColorLabelEntry.BG_SPIELERPOSITONSWERTE,
                                                  SwingConstants.CENTER);
        tabellenwerte[0][4] = new ColorLabelEntry(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Minimal"),
                                                  ColorLabelEntry.FG_STANDARD,
                                                  ColorLabelEntry.BG_SPIELERPOSITONSWERTE,
                                                  SwingConstants.CENTER);

        //Zeilen
        tabellenwerte[1][0] = new ColorLabelEntry(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Stehplaetze"),
                                                  ColorLabelEntry.FG_STANDARD,
                                                  ColorLabelEntry.BG_SPIELERPOSITONSWERTE,
                                                  SwingConstants.LEFT);
        tabellenwerte[2][0] = new ColorLabelEntry(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Sitzplaetze"),
                                                  ColorLabelEntry.FG_STANDARD,
                                                  ColorLabelEntry.BG_SPIELERPOSITONSWERTE,
                                                  SwingConstants.LEFT);
        tabellenwerte[3][0] = new ColorLabelEntry(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Ueberdachteplaetze"),
                                                  ColorLabelEntry.FG_STANDARD,
                                                  ColorLabelEntry.BG_SPIELERPOSITONSWERTE,
                                                  SwingConstants.LEFT);
        tabellenwerte[4][0] = new ColorLabelEntry(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Logen"),
                                                  ColorLabelEntry.FG_STANDARD,
                                                  ColorLabelEntry.BG_SPIELERPOSITONSWERTE,
                                                  SwingConstants.LEFT);
        tabellenwerte[5][0] = new ColorLabelEntry(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Gesamt"),
                                                  ColorLabelEntry.FG_STANDARD,
                                                  ColorLabelEntry.BG_SPIELERPOSITONSWERTE,
                                                  SwingConstants.LEFT);
        tabellenwerte[6][0] = new ColorLabelEntry(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Einnahmen"),
                                                  ColorLabelEntry.FG_STANDARD,
                                                  ColorLabelEntry.BG_SPIELERPOSITONSWERTE,
                                                  SwingConstants.LEFT);
        tabellenwerte[7][0] = new ColorLabelEntry(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Unterhalt"),
                                                  ColorLabelEntry.FG_STANDARD,
                                                  ColorLabelEntry.BG_SPIELERPOSITONSWERTE,
                                                  SwingConstants.LEFT);
        tabellenwerte[8][0] = new ColorLabelEntry(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Gewinn"),
                                                  ColorLabelEntry.FG_STANDARD,
                                                  ColorLabelEntry.BG_SPIELERPOSITONSWERTE,
                                                  SwingConstants.LEFT);
        tabellenwerte[9][0] = new ColorLabelEntry(de.hattrickorganizer.model.HOVerwaltung.instance().getLanguageString("Baukosten"),
                                                  ColorLabelEntry.FG_STANDARD,
                                                  ColorLabelEntry.BG_SPIELERPOSITONSWERTE,
                                                  SwingConstants.LEFT);
    ...
    //Manuelles Init als Teststadium
    ...
    private void reinitTabelle() {
        ...
        if (m_clTyp == HRFARENA) {
            ...
            ((DoppelLabelEntry) tabellenwerte[2][1]).getLinks().setText(stadium.getSitzplaetze()
                                                                        + "");
            ((DoppelLabelEntry) tabellenwerte[3][1]).getLinks().setText(stadium
                                                                        .getUeberdachteSitzplaetze()
                                                                        + "");
            ...
            ((DoppelLabelEntry) tabellenwerte[5][1]).getLinks().setText(stadium.getGesamtgroesse()
                                                                        + "");
            ((DoppelLabelEntry) tabellenwerte[6][1]).getLinks().setSpezialNumber(stadium
                                                                                 .calcMaxEinahmen(),
                                                                                 true);
            ((DoppelLabelEntry) tabellenwerte[7][1]).getLinks().setSpezialNumber(-m_clArenaSizer
                                                                                  .calcUnterhalt(stadium),
                                                                                 true);
            ((DoppelLabelEntry) tabellenwerte[8][1]).getLinks().setSpezialNumber((stadium
                                                                                  .calcMaxEinahmen()
                                                                                 - m_clArenaSizer
                                                                                   .calcUnterhalt(stadium)),
                                                                                 true);
            ...
            for (int i = 2; i < 5; i++) {
                ((DoppelLabelEntry) tabellenwerte[1][i]).getLinks().setText(m_clStadien[i - 2]
                                                                            .getStehplaetze() + "");
                ((DoppelLabelEntry) tabellenwerte[1][i]).getRechts().setSpezialNumber(m_clStadien[i
                                                                                      - 2]
                                                                                      .getStehplaetze()
                                                                                      - stadium
                                                                                        .getStehplaetze(),
                                                                                      false);
                ((DoppelLabelEntry) tabellenwerte[2][i]).getLinks().setText(m_clStadien[i - 2]
                                                                            .getSitzplaetze() + "");
                ((DoppelLabelEntry) tabellenwerte[2][i]).getRechts().setSpezialNumber(m_clStadien[i
                                                                                      - 2]
                                                                                      .getSitzplaetze()
                                                                                      - stadium
                                                                                        .getSitzplaetze(),
                                                                                      false);
                ((DoppelLabelEntry) tabellenwerte[3][i]).getLinks().setText(m_clStadien[i - 2]
                                                                            .getUeberdachteSitzplaetze()
                                                                            + "");
                ((DoppelLabelEntry) tabellenwerte[3][i]).getRechts().setSpezialNumber(m_clStadien[i
                                                                                      - 2]
                                                                                      .getUeberdachteSitzplaetze()
                                                                                      - stadium
                                                                                        .getUeberdachteSitzplaetze(),
                                                                                      false);
                ((DoppelLabelEntry) tabellenwerte[4][i]).getLinks().setText(m_clStadien[i - 2]
                                                                            .getLogen() + "");
                ((DoppelLabelEntry) tabellenwerte[4][i]).getRechts().setSpezialNumber(m_clStadien[i
                                                                                      - 2].getLogen()
                                                                                      - stadium
                                                                                        .getLogen(),
                                                                                      false);
                ((DoppelLabelEntry) tabellenwerte[5][i]).getLinks().setText(m_clStadien[i - 2]
                                                                            .getGesamtgroesse()
                                                                            + "");
                ((DoppelLabelEntry) tabellenwerte[5][i]).getRechts().setSpezialNumber(m_clStadien[i
                                                                                      - 2]
                                                                                      .getGesamtgroesse()
                                                                                      - stadium
                                                                                        .getGesamtgroesse(),
                                                                                      false);
                ((DoppelLabelEntry) tabellenwerte[6][i]).getLinks().setSpezialNumber(m_clStadien[i
                                                                                     - 2]
                                                                                     .calcMaxEinahmen(),
                                                                                     true);
                ((DoppelLabelEntry) tabellenwerte[6][i]).getRechts().setSpezialNumber(m_clStadien[i
                                                                                      - 2]
                                                                                      .calcMaxEinahmen()
                                                                                      - stadium
                                                                                        .calcMaxEinahmen(),
                                                                                      true);
                ((DoppelLabelEntry) tabellenwerte[7][i]).getLinks().setSpezialNumber(-m_clArenaSizer
                                                                                      .calcUnterhalt(m_clStadien[i
                                                                                                     - 2]),
                                                                                     true);
                ((DoppelLabelEntry) tabellenwerte[7][i]).getRechts().setSpezialNumber(-(m_clArenaSizer
                                                                                        .calcUnterhalt(m_clStadien[i
                                                                                                       - 2])
                                                                                      - m_clArenaSizer
                                                                                        .calcUnterhalt(stadium)),
                                                                                      true);
                ((DoppelLabelEntry) tabellenwerte[8][i]).getLinks().setSpezialNumber(m_clStadien[i
                                                                                     - 2]
                                                                                     .calcMaxEinahmen()
                                                                                     - m_clArenaSizer
                                                                                       .calcUnterhalt(m_clStadien[i
                                                                                                      - 2]),
                                                                                     true);
                ((DoppelLabelEntry) tabellenwerte[8][i]).getRechts().setSpezialNumber((m_clStadien[i
                                                                                       - 2]
                                                                                       .calcMaxEinahmen()
                                                                                      - m_clArenaSizer
                                                                                        .calcUnterhalt(m_clStadien[i
                                                                                      ...
                                                                                      - m_clArenaSizer
                                                                                        .calcUnterhalt(stadium)),
                                                                                      true);
                ((DoppelLabelEntry) tabellenwerte[9][i]).getLinks().setSpezialNumber(-m_clStadien[i
                                                                                      - 2]
                                                                                      .getAusbauKosten(),
                                                                                     true);
            }
            ...
            if (m_clStadium != null) {
                ((DoppelLabelEntry) tabellenwerte[1][1]).getLinks().setText(m_clStadium
                                                                            .getStehplaetze() + "");
                ((DoppelLabelEntry) tabellenwerte[1][1]).getRechts().setSpezialNumber(m_clStadium
                                                                                      .getStehplaetze()
                                                                                      - stadium
                                                                                        .getStehplaetze(),
                                                                                      false);
                ((DoppelLabelEntry) tabellenwerte[2][1]).getLinks().setText(m_clStadium
                                                                            .getSitzplaetze() + "");
                ((DoppelLabelEntry) tabellenwerte[2][1]).getRechts().setSpezialNumber(m_clStadium
                                                                                      .getSitzplaetze()
                                                                                      - stadium
                                                                                        .getSitzplaetze(),
                                                                                      false);
                ((DoppelLabelEntry) tabellenwerte[3][1]).getLinks().setText(m_clStadium
                                                                            .getUeberdachteSitzplaetze()
                                                                            + "");
                ((DoppelLabelEntry) tabellenwerte[3][1]).getRechts().setSpezialNumber(m_clStadium
                                                                                      .getUeberdachteSitzplaetze()
                                                                                      - stadium
                                                                                        .getUeberdachteSitzplaetze(),
                                                                                      false);
                ((DoppelLabelEntry) tabellenwerte[4][1]).getLinks().setText(m_clStadium.getLogen()
                                                                            + "");
                ((DoppelLabelEntry) tabellenwerte[4][1]).getRechts().setSpezialNumber(m_clStadium
                                                                                      .getLogen()
                                                                                      - stadium
                                                                                        .getLogen(),
                                                                                      false);
                ((DoppelLabelEntry) tabellenwerte[5][1]).getLinks().setText(m_clStadium
                                                                            .getGesamtgroesse()
                                                                            + "");
                ((DoppelLabelEntry) tabellenwerte[5][1]).getRechts().setSpezialNumber(m_clStadium
                                                                                      .getGesamtgroesse()
                                                                                      - stadium
                                                                                        .getGesamtgroesse(),
                                                                                      false);
                ((DoppelLabelEntry) tabellenwerte[6][1]).getLinks().setSpezialNumber(m_clStadium
                                                                                     .calcMaxEinahmen(),
                                                                                     true);
                ((DoppelLabelEntry) tabellenwerte[6][1]).getRechts().setSpezialNumber(m_clStadium
                                                                                      .calcMaxEinahmen()
                                                                                      - stadium
                                                                                        .calcMaxEinahmen(),
                                                                                      true);
                ((DoppelLabelEntry) tabellenwerte[7][1]).getLinks().setSpezialNumber(-m_clArenaSizer
                                                                                      .calcUnterhalt(m_clStadium),
                                                                                     true);
                ((DoppelLabelEntry) tabellenwerte[7][1]).getRechts().setSpezialNumber(-(m_clArenaSizer
                                                                                        .calcUnterhalt(m_clStadium)
                                                                                      - m_clArenaSizer
                                                                                        .calcUnterhalt(stadium)),
                                                                                      true);
                ((DoppelLabelEntry) tabellenwerte[8][1]).getLinks().setSpezialNumber(m_clStadium
                                                                                     .calcMaxEinahmen()
                                                                                     - m_clArenaSizer
                                                                                       .calcUnterhalt(m_clStadium),
                                                                                     true);
                ((DoppelLabelEntry) tabellenwerte[8][1]).getRechts().setSpezialNumber((m_clStadium
                                                                                       .calcMaxEinahmen()
                                                                                      - m_clArenaSizer
                                                                                        .calcUnterhalt(m_clStadium))
                                                                                      - (stadium
                                                                                      ...
                                                                                      - m_clArenaSizer
                                                                                        .calcUnterhalt(stadium)),
                                                                                      true);
                ((DoppelLabelEntry) tabellenwerte[9][1]).getLinks().setSpezialNumber(-m_clArenaSizer
                                                                                      .calcBauKosten(m_clStadium
                                                                                                     .getStehplaetze()
                                                                                                     - stadium
                                                                                                       .getStehplaetze(),
                                                                                                     m_clStadium
