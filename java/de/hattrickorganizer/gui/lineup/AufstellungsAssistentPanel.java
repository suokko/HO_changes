...
public class AufstellungsAssistentPanel extends ImagePanel implements ActionListener, ItemListener {
    ...
    private final JCheckBox m_jchForm 	= new JCheckBox(HOVerwaltung.instance().getResource().getProperty("Form_beruecksichtigen"),
                                                gui.UserParameter.instance().aufstellungsAssistentPanel_form);
    private final JCheckBox m_jchGesperrte = new JCheckBox(HOVerwaltung.instance().getResource().getProperty("Gesperrte_aufstellen"),
                                                     gui.UserParameter.instance().aufstellungsAssistentPanel_gesperrt);
    private final JCheckBox m_jchIdealPosition = new JCheckBox(HOVerwaltung.instance().getResource().getProperty("Idealposition_zuerst"),
                                                         gui.UserParameter.instance().aufstellungsAssistentPanel_idealPosition);
    private final JCheckBox m_jchLast		= new JCheckBox(HOVerwaltung.instance().getResource().getProperty("NotLast_aufstellen"),
                                                gui.UserParameter.instance().aufstellungsAssistentPanel_notLast);
    private final JCheckBox m_jchListBoxGruppenFilter = new JCheckBox(HOVerwaltung.instance().getResource().getProperty("ListBoxGruppenFilter"),
                                                                gui.UserParameter.instance().aufstellungsAssistentPanel_cbfilter);
    private final JCheckBox m_jchNot 		= new JCheckBox(HOVerwaltung.instance().getResource().getProperty("Not"),
                                               gui.UserParameter.instance().aufstellungsAssistentPanel_not);
    private final JCheckBox m_jchVerletzte = new JCheckBox(HOVerwaltung.instance().getResource().getProperty("Verletze_aufstellen"),
    ...
    private final CBItem[] REIHENFOLGE = {
                                       new CBItem(HOVerwaltung.instance().getResource().getProperty("AW-MF-ST"),
                                    		   ILineUp.AW_MF_ST),
                                                  
                                       new CBItem(HOVerwaltung.instance().getResource().getProperty("AW-ST-MF"),
                                    		   ILineUp.AW_ST_MF),
                                                  
                                       new CBItem(HOVerwaltung.instance().getResource().getProperty("MF-AW-ST"),
                                    		   ILineUp.MF_AW_ST),
                                                  
                                       new CBItem(HOVerwaltung.instance().getResource().getProperty("MF-ST-AW"),
                                    		   ILineUp.MF_ST_AW),
                                                  
                                       new CBItem(HOVerwaltung.instance().getResource().getProperty("ST-AW-MF"),
                                    		   ILineUp.ST_AW_MF),
                                                  
                                       new CBItem(HOVerwaltung.instance().getResource().getProperty("ST-MF-AW"),
                                    		   ILineUp.ST_MF_AW)
                                   };
    ...
    public final void actionPerformed(java.awt.event.ActionEvent actionEvent) {
        ...
        if (actionEvent.getSource().equals(m_jbLoeschen)) {
            ...
            de.hattrickorganizer.gui.HOMainFrame.instance().getInfoPanel().setLangInfoText(de.hattrickorganizer.model.HOVerwaltung.instance()
                                                                                                                                  .getResource()
                                                                                                                                  .getProperty("Aufstellung_geloescht"));
            ...
            mainFrame.getInfoPanel().setLangInfoText(HOVerwaltung.instance()
                                                                                                                                  .getResource()
                                                                                                                                  .getProperty("Autoaufstellung_fertig"));
            mainFrame.getAufstellungsPanel().update();
    ...
    private void initComponents() {
        ...
        m_jcbWetter.setToolTipText(hoVerwaltung.getResource().getProperty("tt_AufstellungsAssistent_Wetter"));
        ...
        m_jchNot.setToolTipText(hoVerwaltung.getResource().getProperty("tt_AufstellungsAssistent_Not"));
        m_jchNot.setOpaque(false);
        m_jchNot.addActionListener(this);
        panel2.add(m_jchNot, BorderLayout.WEST);
        m_jcbGruppe.setToolTipText(hoVerwaltung.getResource().getProperty("tt_AufstellungsAssistent_Gruppe"));
        ...
        m_jchListBoxGruppenFilter.setToolTipText(hoVerwaltung.getResource().getProperty("tt_AufstellungsAssistent_GruppeFilter"));
        ...
        m_jcbReihenfolge.setToolTipText(hoVerwaltung.getResource().getProperty("tt_AufstellungsAssistent_Reihenfolge"));
        ...
        m_jchIdealPosition.setToolTipText(hoVerwaltung.getResource().getProperty("tt_AufstellungsAssistent_Idealposition"));
        m_jchIdealPosition.setOpaque(false);
        panel.add(m_jchIdealPosition);
        m_jchForm.setToolTipText(hoVerwaltung.getResource().getProperty("tt_AufstellungsAssistent_Form"));
        m_jchForm.setOpaque(false);
        panel.add(m_jchForm);
        m_jchVerletzte.setToolTipText(hoVerwaltung.getResource().getProperty("tt_AufstellungsAssistent_Verletzte"));
        m_jchVerletzte.setOpaque(false);
        panel.add(m_jchVerletzte);
        m_jchGesperrte.setToolTipText(hoVerwaltung.getResource().getProperty("tt_AufstellungsAssistent_Gesperrte"));
        m_jchGesperrte.setOpaque(false);
        panel.add(m_jchGesperrte);
        m_jchLast.setToolTipText(hoVerwaltung.getResource().getProperty("tt_AufstellungsAssistent_NotLast"));
        ...
        m_jbLoeschen.setToolTipText(hoVerwaltung.getResource().getProperty("Aufstellung_leeren"));
        m_jbLoeschen.addActionListener(this);
        panel.add(m_jbLoeschen);
        m_jbReserveLoeschen.setPreferredSize(new Dimension(28, 28));
        m_jbReserveLoeschen.setToolTipText(hoVerwaltung.getResource().getProperty("Reservebank_leeren"));
        m_jbReserveLoeschen.addActionListener(this);
        panel.add(m_jbReserveLoeschen);
        m_jbOK.setPreferredSize(new Dimension(28, 28));
        m_jbOK.setToolTipText(hoVerwaltung.getResource().getProperty("Assistent_starten"));
        m_jbOK.addActionListener(this);
        panel.add(m_jbOK);
        m_jbElfmeter.setPreferredSize(new Dimension(28, 28));
        m_jbElfmeter.setToolTipText(hoVerwaltung.getResource().getProperty("Elfmeterschuetzen"));
