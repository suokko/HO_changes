// %1116523448593:hoplugins.commons.ui%
...
public class CompositeIcon implements Icon, SwingConstants {
    ...
    private int fHorizontalOrientation;

    /** Position */
    private int fPosition;

    /** Vertical Orientation */
    private int fVerticalOrientation;

    /**
     * Create a CompositeIcon from the specified Icons, using the default relative position (icon1
     * above icon2) and orientations (centered horizontally and vertically)
     *
     * @param icon1
     * @param icon2
     */
    ...
    /**
     * Create a CompositeIcon from the specified Icons, using the specified relative position and
     * default orientations (centered horizontally and vertically)
     *
     * @param icon1
     * @param icon2
     * @param position
    ...
    public void paintIcon(Component c, Graphics g, int x, int y) {
        ...
        if ((fPosition == LEFT) || (fPosition == RIGHT)) {
            ...
            paintIcon(c, g, rightIcon, x + leftIcon.getIconWidth(), y, width,
                height, LEFT, fVerticalOrientation);
        }
