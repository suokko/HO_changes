...
public class OutputPanel extends JPanel {
    ...
    private void import_matches() {
        ...
        String input = JOptionPane.showInputDialog(PluginProperty.getString("GameID")); //$NON-NLS-1$
    ...
    private void jbInit() {
        ...
        JButton p_JB_berechne = new JButton(PluginProperty.getString("Berechnen")); //$NON-NLS-1$
        ...
        JButton p_JB_import = new JButton(PluginProperty.getString("ImportMatch")); //$NON-NLS-1$
