...
public class TransferTable extends AbstractTable {
     ...
     */
    public void reloadTeamTransfers(int teamid) throws Exception {
        DBZugriff.instance().getAdapter().executeUpdate("DELETE FROM " + getTableName()
    ...
    private boolean addTransfer(PlayerTransfer transfer) {
        ...
        sqlStmt.append("'"+ DBZugriff.insertEscapeSequences(transfer.getPlayerName())+ "',"); 
        sqlStmt.append(transfer.getBuyerid() + ","); 
        sqlStmt.append("'"+ DBZugriff.insertEscapeSequences(transfer.getBuyerName())+ "',"); 
        sqlStmt.append(transfer.getSellerid() + ","); 
        sqlStmt.append("'"+ DBZugriff.insertEscapeSequences(transfer.getSellerName())+ "',"); 
    ...
    private List<PlayerTransfer> loadTransfers(String sqlStmt) {
        ...
        try {
            while (rs.next()) {
                ...
                transfer.setPlayerName( DBZugriff.deleteEscapeSequences(rs.getString("playername"))); 
                ...
                transfer.setBuyerName( DBZugriff.deleteEscapeSequences(rs.getString("buyername"))); 
                transfer.setSellerid(rs.getInt("sellerid")); 
                transfer.setSellerName( DBZugriff.deleteEscapeSequences(rs.getString("sellername"))); 
