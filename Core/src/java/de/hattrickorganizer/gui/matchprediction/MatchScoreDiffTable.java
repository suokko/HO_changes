...
public class MatchScoreDiffTable extends JTable {
	...
	private void initModel(IMatchResult mr,boolean isHome) {
		...
		tableColumnModel.getColumn(tableColumnModel.getColumnIndex(new Integer(1))).setMaxWidth(de.hattrickorganizer.tools.Helper.calcCellWidth(400));
		tableColumnModel.getColumn(tableColumnModel.getColumnIndex(new Integer(1))).setPreferredWidth(de.hattrickorganizer.tools.Helper.calcCellWidth(400));
