...
public class XtraData  {
    ...
    public XtraData(java.util.Properties properties) throws Exception {
        ...
        m_clSeriesMatchDate = ho.core.util.Helper.parseDate(properties.getProperty("seriesmatchdate"));
        m_clEconomyDate = ho.core.util.Helper.parseDate(properties.getProperty("economydate"));
        m_clTrainingDate = ho.core.util.Helper.parseDate(properties.getProperty("trainingdate"));
