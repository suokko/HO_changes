...
public final class Spieler {
    ...
    public void calcIncrementalSubskills(Spieler originalPlayer, int assistants, int trainerlevel, int intensity,
        ...
        incrementSubskills(originalPlayer, assistants, trainerlevel, intensity, stamina,
                wt.getPrimaryTrainingSkill(), tp.getPrimary(), wt);
...
//    		System.out.println ("Clearing stars cache");
        ...
        String key = fo.getPosition() + ":"
        					+ (int)((getTorwart() + getSubskill4Pos(PlayerSkill.KEEPER) + loy) * 100) + "|"
        					+ (int)((getSpielaufbau() + getSubskill4Pos(PlayerSkill.PLAYMAKING) + loy) * 100) + "|"
        					+ (int)((getVerteidigung() + getSubskill4Pos(PlayerSkill.DEFENDING) + loy) * 100) + "|"
        					+ (int)((getFluegelspiel() + getSubskill4Pos(PlayerSkill.WINGER) + loy) * 100) + "|"
        					+ (int)((getPasspiel() + getSubskill4Pos(PlayerSkill.PASSING) + loy) * 100) + "|"
        					+ (int)((getStandards() + getSubskill4Pos(PlayerSkill.SET_PIECES) + loy) * 100) + "|"
        					+ (int)((getTorschuss() + getSubskill4Pos(PlayerSkill.SCORING) + loy) * 100) + "|"
        					+ getForm() + "|"
        					+ getKondition() + "|"
        					+ getErfahrung() + "|"
