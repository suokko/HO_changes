...
public class LigaAuswahlDialog extends JDialog implements ActionListener {
    ...
    private JRadioButton m_jrbLigaAktuell = new JRadioButton(ho.core.model.HOVerwaltung.instance().getLanguageString("AktuelleLiga"),
                                                             true);
    private JRadioButton m_jrbLigaAndere = new JRadioButton(ho.core.model.HOVerwaltung.instance().getLanguageString("AndereLiga"),
                                                            false);
    ...
    private void initComponents(int seasonid) {
        ...
        JLabel label = new JLabel(ho.core.model.HOVerwaltung.instance().getLanguageString("Season"));
        ...
        m_jrbLigaAktuell.setToolTipText(ho.core.model.HOVerwaltung.instance().getLanguageString("tt_LigaDownload_Aktuell"));
    ...
    private int parseInt(Window parent, String text, boolean negativErlaubt) {
        ...
        try {
            ...
            if (!negativErlaubt && (temp < 0)) {
                message = ho.core.model.HOVerwaltung.instance().getLanguageString("negativVerboten");
            ...
            if (message.equals("")) {
                message = ho.core.model.HOVerwaltung.instance().getLanguageString("keineZahl");
            }

            ho.core.util.Helper.showMessage(parent, message,
                                                          ho.core.model.HOVerwaltung.instance().getLanguageString("Fehler"),
