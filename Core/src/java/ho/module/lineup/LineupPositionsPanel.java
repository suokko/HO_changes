 ...
 */
public class LineupPositionsPanel extends ho.core.gui.comp.panel.RasenPanel implements
		ho.core.gui.Refreshable, ho.core.gui.Updateable, ActionListener {
	...
	private void initComponentes() {
		...
		m_jbDrucken.setToolTipText(ho.core.model.HOVerwaltung.instance().getLanguageString(
		...
		m_jbMiniFrame.setToolTipText(ho.core.model.HOVerwaltung.instance().getLanguageString(
		...
		m_jbMidiFrame.setToolTipText(ho.core.model.HOVerwaltung.instance().getLanguageString(
		...
		m_jbFlipSide.setToolTipText(ho.core.model.HOVerwaltung.instance().getLanguageString(
