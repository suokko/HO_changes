 ...
 */
public class LineupPositionsPanel extends ho.core.gui.comp.panel.RasenPanel
    implements ho.core.gui.Refreshable, ho.core.gui.Updateable,
               ActionListener
{
...
//      assistantPanel.addToAssistant(m_clKeeper);
        ...
        m_jbDrucken.setToolTipText(ho.core.model.HOVerwaltung.instance().getLanguageString("tt_AufstellungsPosition_Drucken"));
        m_jbDrucken.addActionListener(this);
        m_jbDrucken.setPreferredSize(new Dimension(25, 25));
        panel.add(m_jbDrucken);
        m_jbMiniFrame.setToolTipText(ho.core.model.HOVerwaltung.instance().getLanguageString("tt_AufstellungsPosition_MiniFrame"));
        m_jbMiniFrame.addActionListener(this);
        m_jbMiniFrame.setPreferredSize(new Dimension(25, 25));
        panel.add(m_jbMiniFrame);
        m_jbMidiFrame.setToolTipText(ho.core.model.HOVerwaltung.instance().getLanguageString("tt_AufstellungsPosition_MidiFrame"));
        m_jbMidiFrame.addActionListener(this);
        m_jbMidiFrame.setPreferredSize(new Dimension(25, 25));
        panel.add(m_jbMidiFrame);
        m_jbFlipSide.setToolTipText(ho.core.model.HOVerwaltung.instance().getLanguageString("tt_AufstellungsPosition_FlipSide"));
