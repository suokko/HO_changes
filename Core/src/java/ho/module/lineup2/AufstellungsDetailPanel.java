...
final class AufstellungsDetailPanel extends JPanel implements Refreshable, ItemListener {
	...
	private CBItem[] SELBSTVERTRAUEN = {
			new CBItem(Team.getNameForSelbstvertrauen(ITeam.SV_nichtVorhanden), ITeam.SV_nichtVorhanden),
			...
			new CBItem(Team.getNameForSelbstvertrauen(ITeam.SV_etwas_ueberheblich),
					ITeam.SV_etwas_ueberheblich),
			new CBItem(Team.getNameForSelbstvertrauen(ITeam.SV_voellig_uebertrieben),
	...
	private CBItem[] STIMMUNG = {
			new CBItem(Team.getNameForStimmung(ITeam.TS_wie_im_kalten_Krieg), ITeam.TS_wie_im_kalten_Krieg),
