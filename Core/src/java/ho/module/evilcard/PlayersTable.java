...
class PlayersTable extends JTable {
    ...
    PlayersTable() {
        ...
        columnToolTips[PlayersTableModel.COL_WARNINGS] = HOVerwaltung.instance().getLanguageString("tooltip.Warnings");
        ...
        columnToolTips[PlayersTableModel.COL_DIRECT_RED_CARDS] = HOVerwaltung.instance().getLanguageString("tooltip.RedCards");
