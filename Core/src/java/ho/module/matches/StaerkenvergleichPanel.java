...
class StaerkenvergleichPanel extends LazyImagePanel {
	...
	protected void update() {
		...
		if (info.getMatchStatus() == MatchKurzInfo.FINISHED) {
			...
			wetterLabel.setIcon(ThemeManager.getIcon(HOIconName.WEATHER[details.getWetterId()]));
	...
	private void initComponents() {
		...
		add(panel, heimStimmungLabel, layout, constraints, 1, 11);
		gastStimmungLabel = new JLabel();
		add(panel, gastStimmungLabel, layout, constraints, 4, 11);
		...
		add(panel, heimSelbstvertrauenLabel, layout, constraints, 1, 12);
		gastSelbstvertrauenLabel = new JLabel();
		add(panel, gastSelbstvertrauenLabel, layout, constraints, 4, 12);
