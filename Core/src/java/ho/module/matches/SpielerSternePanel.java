...
final class SpielerSternePanel extends ImagePanel implements ActionListener {
	...
	private final void initComponents() {
		...
		m_jbSpieler.setToolTipText(ho.core.model.HOVerwaltung.instance().getLanguageString(
	...
	public final void refresh(MatchLineup lineup, MatchLineupPlayer player) {
		...
		if (player != null) {
			...
			m_jbSpieler.setText(player.getSpielerName().substring(0, 1) + "."
					+ player.getSpielerName().substring(player.getSpielerName().indexOf(" ") + 1));
		...
		default: {
			...
			if ((posid >= ISpielerPosition.ausgewechselt)
				...
				m_jlPosition.setText(ho.core.model.player.SpielerPosition
						.getNameForPosition(ho.core.model.player.SpielerPosition.getPosition(posid,
								taktik)));
			}
		}
		}
