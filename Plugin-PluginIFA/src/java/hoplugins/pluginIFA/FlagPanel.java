...
public class FlagPanel extends JPanel {
	...
	private void initialize() {
		...
		this.percentState.setMaximum(PluginIfaUtils.COUNTRIES_COUNT);
		...
		this.percentState.setString(this.countriesPlayedIn + "/"
				+ PluginIfaUtils.COUNTRIES_COUNT + " ("
		...
		add(this.footer, this.constraints, 0, PluginIfaUtils.COUNTRIES_COUNT
