	...
	private Object[][] getTableData() {
		...
		for (int i = 0; i < objects.length; i++) {
			...
			JLabel label = new JLabel(
					PluginIfaUtils.getCountryNameByLeagueID(leagueID));
			label.setIcon(PluginIFA.MINIMODEL.getHelper().getImageIcon4Country(
					PluginIfaUtils.getCountryIDbyLeagueID(leagueID)));
			objects[i][0] = label;
