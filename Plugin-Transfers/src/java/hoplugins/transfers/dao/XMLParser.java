                    ...
                    if (transfer != null) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                Commons.getModel().getHelper().showMessage(Commons.getModel()
                                                                                  .getGUI()
                                                                                  .getOwner4Dialog(),
                                                                           "XML Parse error",
        ...
        try {
            ...
            if (element != null) {
                ...
                if ((list != null) && (list.getLength() > 0)) {
                    ...
                    Commons.getModel().getXMLParser().getFirstChildNodeValue(child);
                    ...
                    if (transfer != null) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                Commons.getModel().getHelper().showMessage(Commons.getModel().getGUI().getOwner4Dialog(),
                                                                           "XML Parse error",
                                                                           "Error parsing XML: transfer '"
