    ...
    implements javax.swing.event.ChangeListener, java.awt.event.ItemListener
{
    ...
    public static GeldFaktorCBItem[] WAEHRUNGEN = {
    ...
    /** TODO Missing Parameter Documentation */
    public static CBItem[] NACHKOMMASTELLEN = {
		 new CBItem("1 (1.2)",1),
		 new CBItem("2 (1.23)",2)
    };

    /** TODO Missing Parameter Documentation */
    public static CBItem[] TIMEZONES = {
	      new CBItem("-24:00",-24),
	      new CBItem("-23:00",-23),
	      new CBItem("-22:00",-22),
	      new CBItem("-21:00",-21),
    ...
    /** TODO Missing Parameter Documentation */
    public CBItem[] SORTIERUNG = {
        new CBItem(HOVerwaltung.instance().getLanguageString("Name"),
                   gui.UserParameter.SORT_NAME),
        new CBItem(HOVerwaltung.instance().getLanguageString("BestePosition"),
                   gui.UserParameter.SORT_BESTPOS),
        new CBItem(HOVerwaltung.instance().getLanguageString("Aufgestellt"),
                   gui.UserParameter.SORT_AUFGESTELLT),
        new CBItem(HOVerwaltung.instance().getLanguageString("Gruppe"),
                   gui.UserParameter.SORT_GRUPPE),
        new CBItem(HOVerwaltung.instance().getLanguageString("Bewertung"),
...
//    private JCheckBox m_jchUpdateCheck;
 ...
 //                                                                 .isSelected();
        ...
        if (itemEvent.getStateChange() == java.awt.event.ItemEvent.SELECTED) {
            ...
            gui.UserParameter.temp().faktorGeld = ((GeldFaktorCBItem) m_jcbWaehrung
            ...
            gui.UserParameter.temp().TimeZoneDifference = ((CBItem) m_jcbTimeZoneDifference
                                                               .getSelectedItem()).getId();
            gui.UserParameter.temp().anzahlNachkommastellen = ((CBItem) m_jcbNachkomma
                                                                   .getSelectedItem()).getId();
            gui.UserParameter.temp().sprachDatei = ((String) m_jcbSprachdatei.getSelectedItem());
            gui.UserParameter.temp().standardsortierung = ((CBItem) m_jcbSortierung
                                                               .getSelectedItem()).getId();            
        }
    ...
    private void initComponents() {
        ...
        //        add( m_jcbHTIP );
        m_jslDeadline = new SliderPanel(HOVerwaltung.instance().getLanguageString("TransferWecker"),
        ...
        m_jslMinStaerke = new SliderPanel(HOVerwaltung.instance().getLanguageString("MinStaerkeIdealPos"),
                                          100, 0, 10, 0.1f, 120);
        ...
        m_jslWetterEffekt = new SliderPanel(HOVerwaltung.instance().getLanguageString("Wettereffekt"),
                                            100, 0, 100, 1f, 120);
		...
		m_jslFutureWeeks = new SliderPanel(HOVerwaltung.instance().getLanguageString("futureWeeks"),
											80, 0, 1, 1f, 120);
        ...
        m_jslSchriftgroesse = new SliderPanel(HOVerwaltung.instance().getLanguageString("Schriftgroesse"),
                                              12, 8, 1, 1.0f, 120);
        ...
        m_jcbSprachdatei = new ComboBoxPanel(HOVerwaltung.instance().getLanguageString("Sprachdatei"),
                                             sprachdateien, 120);
        ...
        m_jcbTimeZoneDifference = new ComboBoxPanel(HOVerwaltung.instance().getLanguageString("options_TimeZone"),
                                                    TIMEZONES, 120);
        ...
        m_jcbWaehrung = new ComboBoxPanel(HOVerwaltung.instance().getLanguageString("Waehrungsfaktor"),
                                          WAEHRUNGEN, 120);
        m_jcbWaehrung.setSelectedId(gui.UserParameter.temp().waehrungsID);
        m_jcbWaehrung.addItemListener(this);

        //        add( m_jcbWaehrung );
        m_jcbSortierung = new ComboBoxPanel(HOVerwaltung.instance().getLanguageString("Defaultsortierung"),
                                            SORTIERUNG, 120);
        ...
        m_jcbNachkomma = new ComboBoxPanel(HOVerwaltung.instance().getLanguageString("Nachkommastellen"),
        ...
        /*
        m_jchEinzelnePositionen = new JCheckBox(HOVerwaltung.instance().getLanguageString("EinzelneTabellenPositionen"));
        m_jchEinzelnePositionen.setToolTipText(HOVerwaltung.instance().getLanguageString("tt_Optionen_EinzelneTabellenPositionen"));
...
*/
        m_jchZahlenBewertung = new JCheckBox(HOVerwaltung.instance().getLanguageString("SkillZahlen")
                                             + " : "
                                             + HOVerwaltung.instance().getLanguageString("passabel")
                                             + " (6)");
