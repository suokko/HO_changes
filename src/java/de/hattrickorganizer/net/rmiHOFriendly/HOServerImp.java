// %2391856555:de.hattrickorganizer.net.rmiHOFriendly%
/*
 * HOServerImp.java
 *
 * Created on 29. Juli 2003, 10:58
 */
...
public class HOServerImp implements Chat {
    ...
    public final boolean isClientBereit() {
        /*
           //Status aktualisierung anfordern
           requestWriteAccess();
     ...
     */
    public final void sendAuswechslung(byte textKey, String teamName, String auswechselSpieler,
     ...
     * @param heim TODO Missing Constructuor Parameter Documentation
     */
    public final void sendFangesang(int key, int art, int variante, String fanTeam,
     ...
     * @param heim TODO Missing Constructuor Parameter Documentation
     */
    public final void sendKarte(byte textKey, String spielerName, int spielminute, int variante,
     ...
     * @param spielminute TODO Missing Constructuor Parameter Documentation
     */
    public final void sendTorchance(boolean heimTeam, String schuetze, String vorbereiter1,
     ...
     * @param heim TODO Missing Constructuor Parameter Documentation
     */
    public final void sendVerletzung(byte textKey, String spielerName, int spielminute,
                                     int variante, int trainerVariante, boolean heim) {
        requestWriteAccess();
    ...
    public final void shutdown() {
        try {
            ...
            //Timeout auf 1  milisekuznde damit port nach close sofort freigegben wird
