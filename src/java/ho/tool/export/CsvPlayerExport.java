		...
		try {
			...
			while (iter.hasNext()) {
				...
				String [] outCols = {
						...
						"" + (curPlayer.getTorwart() + curPlayer.getSubskill4Pos(PlayerSkill.KEEPER)),
						"" + (curPlayer.getSpielaufbau() + curPlayer.getSubskill4Pos(PlayerSkill.PLAYMAKING)),
						"" + (curPlayer.getPasspiel() + curPlayer.getSubskill4Pos(PlayerSkill.PASSING)),
						"" + (curPlayer.getFluegelspiel() + curPlayer.getSubskill4Pos(PlayerSkill.WINGER)),
						"" + (curPlayer.getVerteidigung() + curPlayer.getSubskill4Pos(PlayerSkill.DEFENDING)),
						"" + (curPlayer.getTorschuss() + curPlayer.getSubskill4Pos(PlayerSkill.SCORING)),
						"" + (curPlayer.getStandards() + curPlayer.getSubskill4Pos(PlayerSkill.SET_PIECES)),
