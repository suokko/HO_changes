...
class SpecialEventsDM
{
    ...
    public SpecialEventsDM()
    {
        ...
        babyIcon = ThemeManager.getIcon(HOIconName.GOAL_SPECIAL);//createImageIcon(this, "/hoplugins/specialEvents/img/baby1.gif");
        chanceIcon = ThemeManager.getIcon(HOIconName.NOGOAL);
        leerIcon = ThemeManager.getIcon(HOIconName.EMPTY);
        cornerIcon = ThemeManager.getIcon(HOIconName.GOAL_SPECIAL);//createImageIcon(this, "/hoplugins/specialEvents/img/corner.gif");
    ...
    private String getSEText (MatchHighlight highlight)
    {
    	...
    	if (isWeatherSE(highlight)) {
    		...
    		case IMatchHighlight.HIGHLIGHT_SUB_UNVORHERSEHBAR_PASS_ABGEFANGEN_TOR:
    			return HOVerwaltung.instance().getLanguageString("UNVORHERSEHBAR_PASS_ABGEFANGEN_TOR");
    		...
    		case IMatchHighlight.HIGHLIGHT_SUB_SCHLECHTE_KONDITION_BALLVERLUST_TOR:
    			return HOVerwaltung.instance().getLanguageString("SCHLECHTE_KONDITION_BALLVERLUST_TOR");
